...
Original file is located at
    https://colab.research.google.com/drive/1Q-No8VaE4_QrDKd-1MRJuBC8uF5Zx1rt
...
It only works in _markdown_ __cells__?

`space twice to make blank`
> right?

[Click Here](https://www.google.com) to open link
...
###Third Level in another __Cell__
...
Image.open('cat_example.png')

Image.open('yummy stake.jpg')
